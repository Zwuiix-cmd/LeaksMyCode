...
namespace MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu;

use Closure;
use LogicException;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
...
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\transaction\InvMenuTransaction;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\transaction\InvMenuTransactionResult;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\type\InvMenuType;
use MusuiAntiCheat\Zwuiix\libs\muqsit\invmenu\type\InvMenuTypeIds;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @return InvMenuType
	 *@deprecated Access {@see \PracticeCore\Zwuiix\libs\muqsit\invmenu\InvMenu::$type} directly
	 */
