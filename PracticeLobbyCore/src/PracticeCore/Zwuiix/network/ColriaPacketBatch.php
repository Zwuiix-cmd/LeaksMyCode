...
class ColriaPacketBatch{
	 ...
	 */
	public function getPackets(ColriaNetworkSession $session, PacketSerializerContext $decoderContext, int $max) : Generator{
	...
	private static function newDecoder(ColriaNetworkSession $session, string $buffer, int $offset, PacketSerializerContext $context) : PacketSerializer{
