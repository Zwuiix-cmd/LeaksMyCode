...
class MVChunkRequestTask extends AsyncTask{
	...
	public function onRun() : void{
		...
		$this->setResult($this->compressor->compress(ColriaPacketBatch::fromPackets($pksFactory, LevelChunkPacket::create(new ChunkPosition($this->chunkX, $this->chunkZ), $subCount, false, null, $payload))->getBuffer()));
	}
