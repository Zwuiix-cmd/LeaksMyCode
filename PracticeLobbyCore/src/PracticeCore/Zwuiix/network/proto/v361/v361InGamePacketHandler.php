...
class v361InGamePacketHandler extends InGamePacketHandler{
    ...
    private ColriaNetworkSession $session;
    private v361InventoryManager $inventoryManager;

    public function __construct(Player $player, ColriaNetworkSession $session, v361InventoryManager $inventoryManager){
    ...
    public function handleMobEquipment(MobEquipmentPacket $packet) : bool{
        ...
        if($packet->windowId === ContainerIds::INVENTORY){
            $this->session->hotbarSlot = $packet->hotbarSlot;
            return true;
        }
        return false;
    }
