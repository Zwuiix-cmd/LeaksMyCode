...
class v361RuntimeBlockMapping implements IRuntimeBlockMapping{
	...
	public function __construct(){
		$legacyIdMap = json_decode(file_get_contents(Path::join(MultiProtocol::$resourcePath, "v361", "block_id_map.json")), true);

		$compressedTable = json_decode(file_get_contents(Path::join(MultiProtocol::$resourcePath, "v361", "required_block_states.json")), true);
		$decompressed = [];
