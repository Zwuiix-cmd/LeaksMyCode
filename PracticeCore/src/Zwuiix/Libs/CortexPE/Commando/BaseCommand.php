...
namespace Zwuiix\Libs\CortexPE\Commando;
...
use Zwuiix\Libs\CortexPE\Commando\constraint\BaseConstraint;
use Zwuiix\Libs\CortexPE\Commando\exception\InvalidErrorCode;
use Zwuiix\Libs\CortexPE\Commando\traits\ArgumentableTrait;
use Zwuiix\Libs\CortexPE\Commando\traits\IArgumentable;
...
abstract class BaseCommand extends Command implements IArgumentable, IRunnable, PluginOwned {
	...
	protected array $errorMessages = [
		...
		self::ERR_TOO_MANY_ARGUMENTS => "§cDésolé, vous avez sasie trop d'arguments!",
		self::ERR_INSUFFICIENT_ARGUMENTS => "§cDésolé, l'argument que vous avez saisie est invalide!",
		self::ERR_NO_ARGUMENTS => "§cDésolé, aucun argument n'est requis pour cette commande!",
	];
