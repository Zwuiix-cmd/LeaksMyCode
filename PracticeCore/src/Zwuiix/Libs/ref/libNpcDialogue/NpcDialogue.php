...
namespace Zwuiix\Libs\ref\libNpcDialogue;
...
use Zwuiix\Libs\ref\libNpcDialogue\event\DialogueNameChangeEvent;
use Zwuiix\Libs\ref\libNpcDialogue\form\NpcDialogueButtonData;
