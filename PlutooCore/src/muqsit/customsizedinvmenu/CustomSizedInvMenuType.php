...
use MusuiEssentials\libs\muqsit\invmenu\inventory\InvMenuInventory;
use MusuiEssentials\libs\muqsit\invmenu\InvMenu;
use MusuiEssentials\libs\muqsit\invmenu\type\graphic\ActorInvMenuGraphic;
use MusuiEssentials\libs\muqsit\invmenu\type\graphic\network\ActorInvMenuGraphicNetworkTranslator;
use MusuiEssentials\libs\muqsit\invmenu\type\InvMenuType;
...
final class CustomSizedInvMenuType implements InvMenuType
{
	...
	public function createGraphic(InvMenu $menu, Player $player) : CustomSizedActorInvMenuGraphic
    {
